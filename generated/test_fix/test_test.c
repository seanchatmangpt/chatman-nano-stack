...
/* Test cases */
static void test_test_init() {
    printf("Testing test_bitactor_init...\n");
    ...
    assert(ba.dispatch[TEST_SIGNAL_SEMANTICSIGNAL] == test_handle_semanticsignal_handler);
    assert(ba.dispatch[TEST_SIGNAL_NA13D9CEB402C4351B38704B501D2FDCBB6] == test_handle_na13d9ceb402c4351b38704b501d2fdcbb6_handler);
    assert(ba.dispatch[TEST_SIGNAL_NA13D9CEB402C4351B38704B501D2FDCBB7] == test_handle_na13d9ceb402c4351b38704b501d2fdcbb7_handler);
    assert(ba.dispatch[TEST_SIGNAL_HEARTBEATSIGNAL] == test_handle_heartbeatsignal_handler);
    assert(ba.dispatch[TEST_SIGNAL_NORMALSIGNAL] == test_handle_normalsignal_handler);
    assert(ba.dispatch[TEST_SIGNAL_DEBUGSIGNAL] == test_handle_debugsignal_handler);
    
    printf("✅ test_bitactor_init passed\n");
}
...
static void test_signal_enqueue() {
    ...
    test_signal_t sig = {
        .type = TEST_SIGNAL_SEMANTICSIGNAL,
        .flags = 0,
...
static void test_tick_performance() {
    ...
    test_bitactor_enqueue_signal(&ba, &sig1);
    test_signal_t sig2 = {
        .type = TEST_SIGNAL_NA13D9CEB402C4351B38704B501D2FDCBB6,
        .flags = 0,
        .timestamp = get_timestamp_ns(),
        .payload = 2
    };
    test_bitactor_enqueue_signal(&ba, &sig2);
    test_signal_t sig3 = {
        .type = TEST_SIGNAL_NA13D9CEB402C4351B38704B501D2FDCBB7,
        .flags = 0,
        .timestamp = get_timestamp_ns(),
        .payload = 3
    };
    test_bitactor_enqueue_signal(&ba, &sig3);
...
static void test_ring_buffer_overflow() {
    ...
    while (test_bitactor_enqueue_signal(&ba, &sig)) {
        enqueued++;
        if (enqueued > TEST_RING_SIZE) {
            break; /* Safety check */
        }
    }
    
    assert(enqueued == TEST_RING_SIZE - 1);
...
static void test_semanticsignal_signal() {
    ...
    test_bitactor_enqueue_signal(&ba, &sig);
    test_bitactor_tick(&ba);
    
    assert(ba.signal_count == 1);
    printf("✅ Semantic Signal signal processed\n");
}
static void test_na13d9ceb402c4351b38704b501d2fdcbb6_signal() {
    printf("Testing na13d9ceb402c4351b38704b501d2fdcbb6 signal...\n");
    ...
    assert(ba.signal_count == 1);
    printf("✅ na13d9ceb402c4351b38704b501d2fdcbb6 signal processed\n");
}
static void test_na13d9ceb402c4351b38704b501d2fdcbb7_signal() {
    printf("Testing na13d9ceb402c4351b38704b501d2fdcbb7 signal...\n");
    ...
    assert(ba.signal_count == 1);
    printf("✅ na13d9ceb402c4351b38704b501d2fdcbb7 signal processed\n");
}
static void test_heartbeatsignal_signal() {
    ...
    test_signal_t sig = {
        .type = TEST_SIGNAL_HEARTBEATSIGNAL,
        .flags = 0x1234,
        .timestamp = get_timestamp_ns(),
        .payload = 0xCAFEBABE
    };
...
int main(int argc, char** argv) {
    printf("TEST BitActor Test Suite\n");
    printf("================================\n\n");
    ...
    test_na13d9ceb402c4351b38704b501d2fdcbb6_signal();
    test_na13d9ceb402c4351b38704b501d2fdcbb7_signal();
