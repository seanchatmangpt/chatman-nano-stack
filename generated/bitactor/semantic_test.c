...
static void test_semantic_init() {
    ...
    assert(ba.dispatch[SEMANTIC_SIGNAL_N57BD28A83B9C4A59B77190B1B7415DB5B6] == semantic_handle_n57bd28a83b9c4a59b77190b1b7415db5b6_handler);
    assert(ba.dispatch[SEMANTIC_SIGNAL_N57BD28A83B9C4A59B77190B1B7415DB5B7] == semantic_handle_n57bd28a83b9c4a59b77190b1b7415db5b7_handler);
...
static void test_tick_performance() {
    ...
    semantic_signal_t sig2 = {
        .type = SEMANTIC_SIGNAL_N57BD28A83B9C4A59B77190B1B7415DB5B6,
        .flags = 0,
        .timestamp = get_timestamp_ns(),
        .payload = 2
    };
    ...
    semantic_signal_t sig3 = {
        .type = SEMANTIC_SIGNAL_N57BD28A83B9C4A59B77190B1B7415DB5B7,
        .flags = 0,
        .timestamp = get_timestamp_ns(),
        .payload = 3
    };
...
static void test_n57bd28a83b9c4a59b77190b1b7415db5b6_signal() {
    printf("Testing n57bd28a83b9c4a59b77190b1b7415db5b6 signal...\n");
    ...
    assert(ba.signal_count == 1);
    printf("✅ n57bd28a83b9c4a59b77190b1b7415db5b6 signal processed\n");
}
static void test_n57bd28a83b9c4a59b77190b1b7415db5b7_signal() {
    printf("Testing n57bd28a83b9c4a59b77190b1b7415db5b7 signal...\n");
    ...
    assert(ba.signal_count == 1);
    printf("✅ n57bd28a83b9c4a59b77190b1b7415db5b7 signal processed\n");
}
...
int main(int argc, char** argv) {
    ...
    test_n57bd28a83b9c4a59b77190b1b7415db5b6_signal();
    test_n57bd28a83b9c4a59b77190b1b7415db5b7_signal();
