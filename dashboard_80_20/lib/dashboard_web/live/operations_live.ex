defmodule DashboardWeb.OperationsLive do
  @moduledoc """
  Operations LiveView for CNS Dashboard
  ...
  def render(assigns) do
    ~H"""
    <div class="dashboard-module operations" 
         phx-hook="DashboardModule" 
         id="operations-container">
      
      <.header>
        <%= @page_title %>
        <:subtitle>Real-time operations monitoring</:subtitle>
      </.header>
