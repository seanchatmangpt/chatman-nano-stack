defmodule DashboardWeb.SecurityLive do
  @moduledoc """
  Security LiveView for CNS Dashboard
  ...
  def render(assigns) do
    ~H"""
    <div class="dashboard-module security" 
         phx-hook="DashboardModule" 
         id="security-container">
      
      <.header>
        <%= @page_title %>
        <:subtitle>Real-time security monitoring</:subtitle>
      </.header>
