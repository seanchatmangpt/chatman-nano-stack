defmodule DashboardWeb.BusinessLive do
  @moduledoc """
  Business LiveView for CNS Dashboard
  ...
  def render(assigns) do
    ~H"""
    <div class="dashboard-module business" 
         phx-hook="DashboardModule" 
         id="business-container">
      
      <.header>
        <%= @page_title %>
        <:subtitle>Real-time business monitoring</:subtitle>
      </.header>
