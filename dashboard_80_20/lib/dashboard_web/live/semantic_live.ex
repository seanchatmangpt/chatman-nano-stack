defmodule DashboardWeb.SemanticLive do
  @moduledoc """
  Semantic LiveView for CNS Dashboard
  ...
  def render(assigns) do
    ~H"""
    <div class="dashboard-module semantic" 
         phx-hook="DashboardModule" 
         id="semantic-container">
      
      <.header>
        <%= @page_title %>
        <:subtitle>Real-time semantic monitoring</:subtitle>
      </.header>
