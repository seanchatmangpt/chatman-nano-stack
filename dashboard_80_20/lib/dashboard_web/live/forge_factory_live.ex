defmodule DashboardWeb.Forge_factoryLive do
  @moduledoc """
  Forge_factory LiveView for CNS Dashboard
  ...
  def render(assigns) do
    ~H"""
    <div class="dashboard-module forge_factory" 
         phx-hook="DashboardModule" 
         id="forge_factory-container">
      
      <.header>
        <%= @page_title %>
        <:subtitle>Real-time forge_factory monitoring</:subtitle>
      </.header>
  ...
  defp get_initial_state do
    %{
      page_title: "Forge_factory Dashboard",
      status: "Initializing...",
