defmodule DashboardWeb.ForgeFactoryLiveTest do
  @moduledoc """
  Test module for Forge_Factory LiveView
  ...
  describe "forge_factory live view" do
    test "mounts successfully", %{conn: conn} do
      {:ok, _view, html} = live(conn, "/forge-factory")
      
      assert html =~ "Forge_Factory Dashboard"
    end
    ...
    test "displays initial metrics", %{conn: conn} do
      ...
      {:ok, view, html} = live(conn, "/forge-factory")
    ...
    test "handles real-time updates", %{conn: conn} do
      {:ok, view, _html} = live(conn, "/forge-factory")
  ...
  describe "forge_factory error handling" do
