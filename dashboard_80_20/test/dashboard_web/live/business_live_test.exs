defmodule DashboardWeb.BusinessLiveTest do
  @moduledoc """
  Test module for Business LiveView
  ...
  describe "business live view" do
    test "mounts successfully", %{conn: conn} do
      {:ok, _view, html} = live(conn, "/business")
      
      assert html =~ "Business Dashboard"
    end
    ...
    test "displays initial metrics", %{conn: conn} do
      ...
      {:ok, view, html} = live(conn, "/business")
    ...
    test "handles real-time updates", %{conn: conn} do
      {:ok, view, _html} = live(conn, "/business")
  ...
  describe "business error handling" do
