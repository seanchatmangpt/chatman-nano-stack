...
-spec execute_latency_tests(latency_config()) -> latency_results().
...
-spec collect_latency_samples(atom(), pos_integer(), latency_config()) -> [non_neg_integer()].
...
-spec collect_samples_sequential(atom(), pos_integer(), latency_config()) -> [non_neg_integer()].
collect_samples_sequential(OperationType, SampleCount, Config) ->
...
-spec collect_samples_concurrent(atom(), pos_integer(), pos_integer(), latency_config()) -> [non_neg_integer()].
...
-spec measure_single_operation(atom(), latency_config()) -> non_neg_integer().
...
-spec configure_latency_test(map()) -> latency_config().
...
-spec format_results(latency_results(), latency_config()) -> #{atom() => term()}.
