{application,bitactor,
             [{description,"BitActor - Production Financial Computing Engine"},
              ...
              {modules,[bitactor_app,bitactor_benchmark,bitactor_cluster,
                        bitactor_comprehensive_test_runner,
                        bitactor_coverage_analyzer,
                        bitactor_coverage_validator,bitactor_health,
                        bitactor_meta_test_runner,bitactor_mutation_tester,
                        bitactor_nif,bitactor_performance_validator,
                        bitactor_pool_sup,bitactor_semantic,
