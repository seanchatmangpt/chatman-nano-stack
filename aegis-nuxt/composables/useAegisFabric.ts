...
export const useAegisFabric = () => {
  ...
  const activethreats = computed(() => {
    const threats = []
    threats.push(...attacks.value)
    threats.push(...ddoSattacks.value)
    threats.push(...manInTheMiddleAttacks.value)
    threats.push(...networkAttacks.value)
    threats.push(...phishingAttacks.value)
    threats.push(...threats.value)
    threats.push(...threatIntelligences.value)
    threats.push(...webAttacks.value)
    return threats
  })
