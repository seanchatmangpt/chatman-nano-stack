...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, defineWebSocketHandler, getResponseStatusText } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import wsAdapter from 'file:///Users/sac/cns/aegis-nuxt/node_modules/crossws/dist/adapters/node.mjs';
import { escapeHtml } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/sac/cns/aegis-nuxt/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/nitropack/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///Users/sac/cns/aegis-nuxt/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/sac/cns/aegis-nuxt/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/sac/cns/aegis-nuxt","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/sac/cns/aegis-nuxt/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/sac/cns/aegis-nuxt/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/sac/cns/aegis-nuxt/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/sac/cns/aegis-nuxt/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "wsUrl": "ws://localhost:3000/api/aegis/ws",
...
const _XqYlwXTn2MS7Cxxdz8QAKdysA9NAAch219IttQgxsxE = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/sac/cns/aegis-nuxt";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Real-time cybersecurity threat detection and response dashboard powered by Aegis Fabric"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"Aegis Fabric - Cybersecurity Dashboard"};
...
const _QIzUH8b99pg6Qf6nKPzWInjuCmAwQDmxmE_T9q9fDJo = (nitroApp) => {
...
const plugins = [
  _XqYlwXTn2MS7Cxxdz8QAKdysA9NAAch219IttQgxsxE,
_QIzUH8b99pg6Qf6nKPzWInjuCmAwQDmxmE_T9q9fDJo
];
...
const _tRnUv7 = eventHandler((event) => {
...
const getServerEntry = () => import('file:///Users/sac/cns/aegis-nuxt/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/sac/cns/aegis-nuxt/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_ALHJ2i = () => Promise.resolve().then(function () { return ws$1; });
const _lazy_zfVZlC = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _tRnUv7, lazy: false, middleware: true, method: undefined },
  { route: '/api/aegis/ws', handler: _lazy_ALHJ2i, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_zfVZlC, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_zfVZlC, lazy: true, middleware: false, method: undefined }
];
