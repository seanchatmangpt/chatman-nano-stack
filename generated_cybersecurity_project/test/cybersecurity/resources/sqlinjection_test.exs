defmodule Cybersecurity.Resources.SQLInjectionTest do
  ...
  describe "create action" do
    test "creates sqlinjection with valid attributes" do
      ...
      assert {:ok, sqlinjection} = Ash.create(SQLInjection, attrs)
    ...
    test "fails with invalid attributes" do
      ...
      assert {:error, %Ash.Error.Invalid{}} = Ash.create(SQLInjection, attrs)
    end
  end
  ...
  describe "read action" do
    test "reads existing sqlinjection" do
      ...
      assert {:ok, found_sqlinjection} = Ash.get(SQLInjection, sqlinjection.id)
    ...
    test "lists all sqlinjections" do
      ...
      assert {:ok, sqlinjections} = Ash.read(SQLInjection)
    ...
    test "filters by status" do
      ...
      assert {:ok, [sqlinjection]} = Ash.read(SQLInjection, action: :by_status, status: :active)
  ...
  describe "update action" do
    test "updates sqlinjection attributes" do
      ...
      assert {:ok, updated_sqlinjection} = Ash.update(sqlinjection, %{name: "Updated Name"})
    ...
    test "activates sqlinjection" do
      ...
      assert {:ok, activated_sqlinjection} = Ash.update(sqlinjection, action: :activate)
  ...
  describe "destroy action" do
    test "destroys existing sqlinjection" do
      ...
      assert :ok = Ash.destroy(sqlinjection)
      assert {:error, %Ash.Error.Invalid{}} = Ash.get(SQLInjection, sqlinjection.id)
    end
  end
end
