defmodule Cybersecurity.Workflows.LateralMovementWorkflow do
  @moduledoc """
  Workflow for LateralMovement resource operations
  """

  # 80/20: Plain Elixir workflow for LateralMovement resource operations
  
  @doc """
  Execute a lateralmovement resource action
  """
