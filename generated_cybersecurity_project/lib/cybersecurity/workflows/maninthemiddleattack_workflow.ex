defmodule Cybersecurity.Workflows.ManInTheMiddleAttackWorkflow do
  @moduledoc """
  Workflow for ManInTheMiddleAttack resource operations
  """

  # 80/20: Plain Elixir workflow for ManInTheMiddleAttack resource operations
  
  @doc """
  Execute a maninthemiddleattack resource action
  """
