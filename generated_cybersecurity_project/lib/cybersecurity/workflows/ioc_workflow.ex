defmodule Cybersecurity.Workflows.IOCWorkflow do
  @moduledoc """
  Workflow for IOC resource operations
  """

  # 80/20: Plain Elixir workflow for IOC resource operations
  
  @doc """
  Execute a ioc resource action
  """
